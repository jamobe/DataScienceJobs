#scrape glossarytech.com, to give a list of tech terms for one-hot encoding of job descriptions
...
# clean up values in dictionary, add spaces either side so we are not capturing common langiage occurences of some words.
