...
if __name__ == "__main__":
   ...
   # BOG_val = BOG_model.transform(x_val['full_description']).toarray()
    ...
    with open(path + '/data/OHE_low_salary.pkl', 'wb') as file:
        pickle.dump(OHE_train, file)
    with open(path + '/data/TFIDF_low_salary.pkl', 'wb') as file:
        pickle.dump(TFIDF_train, file)
    with open(path + '/data/BOG_low_salary.pkl', 'wb') as file:
        pickle.dump(BOG_train, file)
    with open(path + '/data/TECH_low_salary.pkl', 'wb') as file:
        pickle.dump(TECH_train, file)
    with open(path + '/data/yTrainValTest_low_salary.pkl', 'wb') as file:
        pickle.dump(y_train, file)
    with open(path + '/data/IndexTrainValTest_low_salary.pkl', 'wb') as file:
