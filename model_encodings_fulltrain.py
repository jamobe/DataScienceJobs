...
if __name__ == "__main__":
    ...
    train_index, x_train, y_train, test_index, x_test, y_test = splitting_test(df_filtered)
    ...
    with open(path + '/Pickles/OHE_all.pkl', 'wb') as file:
    ...
    with open(path + '/Pickles/BOG_all.pkl', 'wb') as file:
    ...
    with open(path + '/Pickles/TFIDF_all.pkl', 'wb') as file:
    ...
    with open(path + '/Pickles/TECH_all.pkl', 'wb') as file:
    ...
    X_Train.to_csv(path + '/Pickles/X_Train_all.csv')
    X_Test.to_csv(path + '/Pickles/X_Test_all.csv')

    y_train.to_csv(path + '/Pickles/Y_Train_all.csv', header=True, index=False)
    y_test.to_csv(path + '/Pickles/Y_Test_all.csv', header=True, index=False)

    train_index.to_csv(path + '/Pickles/Train_index_all.csv', header=True, index=False)
    test_index.to_csv(path + '/Pickles/Test_index_all.csv', header=True, index=False)
